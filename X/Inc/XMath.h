...
struct Vector4
{
	...
	static Vector4 LightGreen()					{ return Vector4(0.5f, 1.0f, 0.5f, 1.0f); }
	static Vector4 Green()						{ return Vector4(0.0f, 1.0f, 0.0f, 1.0f); }
	static Vector4 LightBlue()					{ return Vector4(0.5f, 0.5f, 1.0f, 1.0f); }
	static Vector4 Blue()						{ return Vector4(0.0f, 0.0f, 1.0f, 1.0f); }
	static Vector4 DarkBlue()					{ return Vector4(0.0f, 0.0f, 0.5f, 1.0f); }
